...
namespace Sunny.UI {
    ...
    public sealed class UIListBox: UIPanel, IToolTip {
        ...
        public override void SetStyleColor(UIBaseStyle uiColor) {
            ...
            if (bar != null) {
                bar.ForeColor = 全局字符串.主题色;
                bar.HoverColor = 全局字符串.次级主题色;
                bar.PressColor = 全局字符串.背景色;
                bar.FillColor = 全局字符串.背景色;

                scrollBarColor = 全局字符串.主题色;
                scrollBarBackColor = 全局字符串.背景色;
            }

            hoverColor = 全局字符串.次级主题色;
            if (listbox != null) {
                listbox.HoverColor = 全局字符串.次级主题色;
                //listbox.SetStyleColor(uiColor);
                listbox.BackColor = 全局字符串.背景色;
                listbox.ForeColor = 全局字符串.主题色;
            }

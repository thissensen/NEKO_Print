...
namespace Sunny.UI
{
    ...
    public static class FontImageHelper
    {
        ...
        {
            FontAwesomeV4 = new FontImages(翻译姬.Properties.Resources.FontAwesome);
            ElegantIcons = new FontImages(翻译姬.Properties.Resources.ElegantIcons);
            FontAwesomeV5Brands = new FontImages(翻译姬.Properties.Resources.fa_brands_400);
            FontAwesomeV5Regular = new FontImages(翻译姬.Properties.Resources.fa_regular_400);
            FontAwesomeV5Solid = new FontImages(翻译姬.Properties.Resources.fa_solid_900);
